{
  pkgs = hackage:
    {
      packages = {
        "warp".revision = (((hackage."warp")."3.3.2").revisions).default;
        ...
        "github".revision = (((hackage."github")."0.22").revisions).default;
        ...
        "hpack".revision = (((hackage."hpack")."0.32.0").revisions).default;
